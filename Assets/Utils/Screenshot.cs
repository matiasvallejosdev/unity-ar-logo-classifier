...
namespace Components.Utils
{
    ...
    {
        private static string TEMP_FILE_NAME = ".jpg";
        ...
        public static void SaveScreenshot(Texture2D screenshot)
        {
            string dateTimeName = System.DateTime.Now.ToString("yyyy-MM-dd_HH-mm-ss");
            byte[] textureBytes = screenshot.EncodeToPNG();
            string filePath = Path.Combine(Application.persistentDataPath, $"{dateTimeName}{TEMP_FILE_NAME}");
