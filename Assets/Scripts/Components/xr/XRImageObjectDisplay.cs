...
namespace Components
{
    public class XRImageObjectDisplay : MonoBehaviour
    {
        ...
        private void OnTrackedImagesChanged(ARTrackedImagesChangedEventArgs eventArgs)
        {
            ...
            try
            {
                ...
                foreach (ARTrackedImage trackedImage in eventArgs.updated)
                {
                    ...
                    if (trackedImage.trackingState == TrackingState.Tracking && _instantiatedARPrefabs.ContainsKey(key))
                    {
        ...
        private void InstanceARPrefab(ARTrackedImage trackedImage)
        {
            ...
            string name = recognitionManager.recognitionResponse.Value.recognition.ToString().ToLower();
